...
public class CdstrStudent extends JDialog {
	...
	public CdstrStudent(Admin adm) {
		...
		listTurmas.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				btnTurmas.setIcon(new ImageIcon(ViewStudentsList.class.getResource("/img/seta_de_itens_icon.png")));
			}
		});
	...
	private void cadastrar() {
		...
		if (!(textFieldNome.getText().isBlank() || textFieldMatricula.getText().isEmpty()
				|| textFieldSenha.getText().isBlank() || textFieldTurma.getText().isBlank())) {
