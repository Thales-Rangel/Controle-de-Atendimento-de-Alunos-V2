...
public class ViewStudent extends JPanel {
	...
	public ViewStudent(Admin adm, Student s) {
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int confirma = JOptionPane.showConfirmDialog(null,
						"Tem certeza que deseja excluir esse(a) aluno(a) permanentemente?");
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup().addGap(10)
						.addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 826, Short.MAX_VALUE).addGap(10))
				.addGroup(groupLayout.createSequentialGroup().addGap(10)
						.addComponent(scrollPaneDisciplinas, GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE).addGap(10)
						.addComponent(scrollPaneProfessores, GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnReturn,
												GroupLayout.PREFERRED_SIZE, 232, GroupLayout.PREFERRED_SIZE))
								.addGroup(groupLayout.createSequentialGroup()
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												.addComponent(btnDelete, GroupLayout.PREFERRED_SIZE, 232,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGap(10).addComponent(panel, GroupLayout.DEFAULT_SIZE, 88, Short.MAX_VALUE).addGap(9)
				.addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE).addGap(10)
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(scrollPaneDisciplinas, GroupLayout.PREFERRED_SIZE, 419,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(scrollPaneProfessores, GroupLayout.DEFAULT_SIZE, 419, Short.MAX_VALUE)
						.addGroup(groupLayout.createSequentialGroup().addGap(108).addComponent(btnDelete)
	...
	private void listar() {
		...
		String readP = "select p.nome from estuda es join ensina en on es.id_disciplina = en.id_disciplina "
				+ "join professores p on p.matricula = en.matricula_professor where es.id_turma= ? "
