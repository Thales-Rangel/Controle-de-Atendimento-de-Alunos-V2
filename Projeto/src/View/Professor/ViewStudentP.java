...
public class ViewStudentP extends JPanel {
	...
	public ViewStudentP(Student s, ProfessorView pv) {
		...
		try {
			...
			pst = con.prepareStatement(
					"select count(s.id) from alunos a left join solicitacoes s on s.matricula_a = a.matricula and s.matricula_p= '"
							+ pv.prof.getMatricula() + "' where a.matricula= '" + s.getMatricula()
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(lblSolicitations, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 617,
								Short.MAX_VALUE)
						.addComponent(lblStudent, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 617, Short.MAX_VALUE))
				.addContainerGap()));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(lblStudent)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblSolicitations)
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 511, Short.MAX_VALUE).addContainerGap()));
	...
	private void listar() {
		DefaultTableModel model = new DefaultTableModel(new Object[][] {},
				new String[] { "ID", "Duvida", "Respondido" }) {
			private static final long serialVersionUID = 1L;
		...
		String readSolicitations = "select s.id, s.duvida, s.respondido from solicitacoes s where matricula_a= '"
				+ s.getMatricula() + "' and matricula_p= '" + pv.prof.getMatricula() + "'";
