...
public class ViewSolicitationsListP extends JPanel {
	...
	private void listar() {
		...
		String readSolicitacoes = "select s.id, a.nome, s.duvida, d.nome, s.respondido from solicitacoes s "
				+ "join alunos a on a.matricula = s.matricula_a join disciplinas d on d.id = s.id_disciplina "
				+ "where s.matricula_p= '" + p.getMatricula() + "' and s.respondido= 'F' order by s.id desc";
		...
		try {
			if (DoT) {
				if (scrollPaneDisciplinas.isVisible() && listDisciplinas.isVisible()) {
					...
					scrollPaneDisciplinas.setVisible(false);
					listDisciplinas.setVisible(false);
					btnDisciplinas.setIcon(
							new ImageIcon(ViewSolicitationsListP.class.getResource("/img/seta_de_itens_icon.png")));
				...
				btnDisciplinas.setIcon(new ImageIcon(
						ViewSolicitationsListP.class.getResource("/img/seta_de_itens_para_cima_icon.png")));
				...
				String readTurmas = "select t.nome from ensina en join estuda es "
						+ "on en.id_disciplina = es.id_disciplina join turmas t on t.id = es.id_turma "
						+ "where en.matricula_professor= '" + p.getMatricula() + "' group by t.id order by t.nome";
				...
				btnTurmas.setIcon(new ImageIcon(
						ViewSolicitationsListP.class.getResource("/img/seta_de_itens_para_cima_icon.png")));
	...
	private void buscar() {
		...
		String busca = "select s.id, a.nome, s.duvida, d.nome, s.respondido from solicitacoes s join alunos a "
				+ "on a.matricula = s.matricula_a join disciplinas d on d.id = s.id_disciplina "
	...
	private void dimensionar() {
		...
		gl_panel.setHorizontalGroup(
				gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup().addGap(8).addComponent(lblBusca,
								GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE))
						.addGroup(
								gl_panel.createSequentialGroup().addContainerGap()
										.addComponent(rdbtnResp, GroupLayout.PREFERRED_SIZE, 143,
												GroupLayout.PREFERRED_SIZE)
										.addContainerGap(83, Short.MAX_VALUE))
						.addGroup(
								gl_panel.createSequentialGroup().addContainerGap()
										.addComponent(lblNewLabel, GroupLayout.PREFERRED_SIZE, 159,
												GroupLayout.PREFERRED_SIZE)
										.addContainerGap(63, Short.MAX_VALUE))
						.addGroup(
								gl_panel.createSequentialGroup().addContainerGap()
										.addComponent(rdbtnNaoResp, GroupLayout.PREFERRED_SIZE, 160,
												GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(gl_panel
								...
								.addComponent(
										lblNewLabel_1, GroupLayout.PREFERRED_SIZE, 159, GroupLayout.PREFERRED_SIZE)
								.addContainerGap(63, Short.MAX_VALUE))
						.addGroup(gl_panel.createSequentialGroup().addGap(13).addGroup(gl_panel
								.createParallelGroup(Alignment.LEADING)
								.addComponent(textFieldDisciplinas, GroupLayout.PREFERRED_SIZE, 173,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(scrollPaneDisciplinas, GroupLayout.PREFERRED_SIZE, 199,
										GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_panel.createSequentialGroup().addGap(174).addComponent(btnDisciplinas,
										GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)))
								.addContainerGap(20, Short.MAX_VALUE))
						.addGroup(gl_panel.createSequentialGroup().addGap(14).addGroup(gl_panel
								.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel.createSequentialGroup()
										.addComponent(textFieldTurmas, GroupLayout.PREFERRED_SIZE, 173,
												GroupLayout.PREFERRED_SIZE)
										.addGap(1).addComponent(btnTurmas, GroupLayout.PREFERRED_SIZE, 25,
												GroupLayout.PREFERRED_SIZE))
								.addComponent(scrollPaneTurmas, GroupLayout.PREFERRED_SIZE, 199,
										GroupLayout.PREFERRED_SIZE))
						...
						.addGroup(gl_panel.createSequentialGroup().addContainerGap().addGroup(gl_panel
								...
								.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
										.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
												...
												.addGroup(gl_panel.createSequentialGroup().addComponent(textFieldSearch,
														GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)))
										.addGap(18))
								.addGroup(gl_panel.createSequentialGroup()
										.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
												.addGroup(gl_panel.createSequentialGroup()
														.addComponent(lblNewLabel_2, GroupLayout.PREFERRED_SIZE, 184,
																GroupLayout.PREFERRED_SIZE)
														.addGap(15))
												.addComponent(lblNewLabel_4))
										.addContainerGap(23, Short.MAX_VALUE)))));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel
				.createSequentialGroup().addContainerGap().addComponent(lblBusca).addGap(18)
				...
				.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createSequentialGroup().addGap(23).addComponent(scrollPaneDisciplinas,
				...
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addComponent(lblNewLabel_2, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE).addGap(10)
				.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createSequentialGroup().addGap(23).addComponent(scrollPaneTurmas,
								GroupLayout.PREFERRED_SIZE, 81, GroupLayout.PREFERRED_SIZE)))
				.addGap(10).addComponent(lblNewLabel_3, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(textFieldSearch, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE).addGap(143)
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
								.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE).addGap(243))
						.addGroup(groupLayout.createSequentialGroup()
								.addComponent(lblTitle, GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE).addGap(192)
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup().addGap(10)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup().addGap(37).addComponent(scrollPane,
