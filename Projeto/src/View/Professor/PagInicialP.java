...
public class PagInicialP extends JPanel {
	...
	public PagInicialP(Professor p) {
		...
		gl_panelCabecalho.setHorizontalGroup(gl_panelCabecalho.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelCabecalho.createSequentialGroup().addGap(8)
		...
		gl_panelCabecalho.setVerticalGroup(gl_panelCabecalho.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelCabecalho.createSequentialGroup().addGap(8)
						.addComponent(lblNome, GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE).addGap(10)
		...
		lblDisciplinas = new JLabel("Minhas disciplinas: " + p.getDisciplinas().size());
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(panelCabecalho, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE)
						...
						.addGroup(groupLayout.createSequentialGroup()
								...
								.addGap(10).addComponent(scrollPaneSolicitations_1_1, GroupLayout.DEFAULT_SIZE, 198,
										Short.MAX_VALUE)))
				.addGap(10)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup().addGap(10)
				.addComponent(panelCabecalho, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addGap(10).addComponent(panelRecebidos, GroupLayout.PREFERRED_SIZE, 55, GroupLayout.PREFERRED_SIZE)
				.addGap(10)
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
	...
	private void contagem() {
		...
		String readTurmas = "select count(distinct es.id_turma) from estuda es join ensina en "
				+ "on en.id_disciplina = es.id_disciplina where en.matricula_professor= '" + p.getMatricula()
				+ "'";
	...
	private void listagens() {
		String readSolicitacoes = "select duvida from solicitacoes where respondido= 'F' and matricula_p= '"
				+ p.getMatricula() + "' order by id desc";
		...
		for (int i = 0; i < p.getDisciplinas().size(); i++)
			modelDisciplinas.addRow(new Object[] { p.getDisciplinas().get(i).getNome() });
